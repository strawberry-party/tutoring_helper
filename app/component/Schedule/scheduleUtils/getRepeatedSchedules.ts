...
export function test_getRepeatedSchedules() {
  ...
  console.log('====================================');
  console.log('test_getRepeatedSchedules');
  console.log('====================================');
  console.log('====================================');

  const schedules = getRepeatedSchedules(
    startPoint,
    endPoint,
    dailyLessonTime,
    formWorkSchedule,
...
export default function getRepeatedSchedules(
  ...
  while (!currentDay.isAfter(endPoint)) {
    ...
    var currentSchedule: ScheduleType = new ScheduleType(
      linkedRepeatedScheduleInfoId,
      text,
      studentId,
      tagId,
